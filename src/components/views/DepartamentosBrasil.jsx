  ...
  return (
    <section>
        ...
        <Col lg={5} sm={12}>
          ...
          <div className="pt-3">
            <p>
              ...
              alias eligendi necessitatibus aut, totam ad soluta cum nemo
              dignissimos eius magnam autem expedita mollitia! Fuga ipsum ea
              tempora consectetur delectus repellat consequuntur non ut hic
              eligendi? Sunt hic soluta veniam atque suscipit earum ratione
              commodi quos. Eum, velit! Minima, laboriosam?
            </p>
      ...
      <article className="container-fluid row py-5 justify-content-between colorFondo posicionFija flex-column-reverse flex-lg-row">
        ...
        <Col lg={5} sm={12}>
          <h2 className="text-primary text-center display-4">Departamento 2</h2>
          <div className="pt-3">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
              alias eligendi necessitatibus aut, totam ad soluta cum nemo
...
export default DepartamentosBrasil;
